...
Indexed by [Repowise](https://repowise.dev). Last indexed: 2026-08-08 (commit 9e2bc2a). Confidence: 98%.
...
- `packages/mcp/src/server.ts` — 3 bug fixes, last fix 3 days ago; 16 commits/90d
- `packages/app/src/index.tsx` — 3 bug fixes, last fix 7 days ago; 18 commits/90d
- `tests/mcp-tools.test.ts` — 2 bug fixes, last fix 3 days ago; 12 commits/90d
...
### Code health
Three co-equal signals: defect risk 6.09/10 avg, hotspot health 4.61/10 (stable), worst `packages/cli/src/index.ts` at 1.0/10 · maintainability 8.45/10 · performance risk 39 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
